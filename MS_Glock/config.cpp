...
class cfgWeapons
{
	...
	class SlotInfo;
	class UGL_F;
	class MS_Glock: Pistol_Base_F //slaves off Arma's Pistol_Base_F class. The values defined below overwrite Pistol_Base_F, anything not defined is inherited. Consult the wiki/sample content for a full config with every possible value.
    {
        ...
        magazines[] = {"16Rnd_9x21_Mag", "30Rnd_9x21_Mag"};//list of magazines this weapon takes
