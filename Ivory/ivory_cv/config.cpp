...
class CfgVehicles
{
	...
	class ivory_cv_base: Car_F
	{
		model 	= "\ivory_cv\ivory_cv";  /// simple path to model
		picture = "\ivory_cv\data\portrait_car_CA.paa";
		Icon	= "\ivory_cv\data\map_car_CA.paa";
		editorPreview = "\ivory_cv\data\ivory_cv.jpg";
		...
		displayName = "Ford Crown Victoria"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_cv_driver";
		driverInAction = "ivory_cv_driver";
		cargoAction[] = {"ivory_cv_cargo","ivory_cv_cargo2","ivory_cv_cargo3"};
		cargoInAction[] = {"ivory_cv_cargo","ivory_cv_cargo2","ivory_cv_cargo3"};
	...
	class ivory_cv: ivory_cv_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_cv_marked: ivory_cv_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_cv\data\ivory_cv_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_marked_norb: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_cv\data\ivory_cv_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_marked_classic: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_cv\data\ivory_cv_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_cv_unmarked: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_cv\data\ivory_cv_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_unmarked_norb: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_cv\data\ivory_cv_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_slicktop: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_cv\data\ivory_cv_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_slicktop_norb: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_cv\data\ivory_cv_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_cv_slicktop_classic: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_cv\data\ivory_cv_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_cv_taxi: ivory_cv_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Taxi)";
	...
	class ivory_cv_unmarked_taxi: ivory_cv_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Ford Crown Victoria (Police/Unmarked/Taxi)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_cv\data\ivory_cv_unmarked_taxi.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_cv_driver = "ivory_cv_driver";
		ivory_cv_cargo = "ivory_cv_cargo";
		ivory_cv_cargo2 = "ivory_cv_cargo2";
		ivory_cv_cargo3 = "ivory_cv_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_cv_driver: Crew
		{
			file = "ivory_cv\anim\driver.rtm";
		};
		class ivory_cv_cargo: Crew
		{
			file = "ivory_cv\anim\cargo.rtm";
		};
		class ivory_cv_cargo2: Crew
		{
			file = "ivory_cv\anim\cargo2.rtm";
		};
		class ivory_cv_cargo3: Crew
		{
			file = "ivory_cv\anim\cargo3.rtm";
		};
	};
};
...
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_cv\data\cv_police.paa"; 
	};
	class cv_taxi
	{
		displayName = "Taxi"; 
		texture = "ivory_cv\data\cv_taxi.paa"; 
	};
};