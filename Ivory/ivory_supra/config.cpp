...
class CfgVehicles
{
	...
	class ivory_supra_base: Car_F
	{
		model 	= "\ivory_supra\ivory_supra";  /// simple path to model
		picture = "\ivory_supra\data\portrait_car_CA.paa";
		Icon	= "\ivory_supra\data\map_car_CA.paa";
		editorPreview = "\ivory_supra\data\ivory_supra.jpg";
		...
		displayName = "Toyota Supra"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_supra_driver";
		driverInAction = "ivory_supra_driver";
		cargoAction[] = {"ivory_supra_cargo"};
		cargoInAction[] = {"ivory_supra_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_supra\data\toyota_supra_wheel_diffuse_00.paa",
	...
	class ivory_supra: ivory_supra_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_supra_topsecret: ivory_supra_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		editorSubcategory="Ivory";
		scope	= 2; 			/// makes the car visible in editor
		...
		displayName = "Toyota Supra (Top Secret)";
		model 	= "\ivory_supra\ivory_supra_topsecret";
		editorPreview = "\ivory_supra\data\ivory_supra_topsecret.jpg";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_supra_driver = "ivory_supra_driver";
		ivory_supra_cargo = "ivory_supra_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_supra_driver: Crew
		{
			file = "ivory_supra\anim\driver.rtm";
		};
		class ivory_supra_cargo: Crew
		{
			file = "ivory_supra\anim\cargo.rtm";
		};
	};
};