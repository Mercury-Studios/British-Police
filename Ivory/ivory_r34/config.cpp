...
class CfgVehicles
{
	...
	class ivory_r34_base: Car_F
	{
		model 	= "\ivory_r34\ivory_r34";  /// simple path to model
		picture = "\ivory_r34\data\portrait_car_CA.paa";
		Icon	= "\ivory_r34\data\map_car_CA.paa";
		editorPreview = "\ivory_r34\data\ivory_r34.jpg";
		...
		displayName = "Nissan Skyline GT-R"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_r34_driver";
		driverInAction = "ivory_r34_driver";
		cargoAction[] = {"ivory_r34_cargo","ivory_r34_cargo2","ivory_r34_cargo3"};
		cargoInAction[] = {"ivory_r34_cargo","ivory_r34_cargo2","ivory_r34_cargo3"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_r34\data\nissan_skyline_r34_wheel_diffuse_00.paa",
	...
	class ivory_r34: ivory_r34_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_r34_driver = "ivory_r34_driver";
		ivory_r34_cargo = "ivory_r34_cargo";
		ivory_r34_cargo2 = "ivory_r34_cargo2";
		ivory_r34_cargo3 = "ivory_r34_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_r34_driver: Crew
		{
			file = "ivory_r34\anim\driver.rtm";
		};
		class ivory_r34_cargo: Crew
		{
			file = "ivory_r34\anim\cargo.rtm";
		};
		class ivory_r34_cargo2: Crew
		{
			file = "ivory_r34\anim\cargo2.rtm";
		};
		class ivory_r34_cargo3: Crew
		{
			file = "ivory_r34\anim\cargo3.rtm";
		};
	};
};