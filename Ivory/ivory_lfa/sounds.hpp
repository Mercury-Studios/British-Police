...
soundDammage[]={"", db-5, 1};
soundEngineOnInt[] = {"ivory_lfa\sound\lfa_startup.wss", db-8, 1.0};
soundEngineOnExt[] = {"ivory_lfa\sound\lfa_startup.wss", db-7, 1.0, 200};
...
class Sounds
{
	...
	class Idle_ext
	{
		sound[]	=	{"ivory_lfa\sound\lfa_idle", db-15,	1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*VOLUME_IDLE;
	};
	class Engine
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offlow",	db-15,1, 100};
	...
	class Engine2_ext
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offmid",	db-15,1, 100};
	...
	class Engine4_ext
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offhigh",	db-15,1, 100};
	...
	class IdleThrust
	{
	sound[] = {"ivory_lfa\sound\lfa_onidle", db-15,1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust
	{
	sound[] = {"ivory_lfa\sound\lfa_onlow", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_lfa\sound\lfa_onmid", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	{
	sound[] = {"ivory_lfa\sound\lfa_onhigh", db-15,1, 100};
	...
	class Idle_int
	{
		sound[]	=	{"ivory_lfa\sound\lfa_idle", db-30,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*VOLUME_IDLE;
	};
	class Engine_int
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offlow",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	class Engine2_int
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offmid",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	class Engine4_int
	{
		sound[]	=	{"ivory_lfa\sound\lfa_offhigh",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
	...
	{
	sound[] = {"ivory_lfa\sound\lfa_onidle", db-30,1 };
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust_int
	{
	sound[] = {"ivory_lfa\sound\lfa_onlow", db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_lfa\sound\lfa_onmid", db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	{
	sound[] = {"ivory_lfa\sound\lfa_onhigh", db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.3;
