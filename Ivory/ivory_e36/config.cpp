...
class CfgVehicles
{
	...
	class ivory_e36_base: Car_F
	{
		model 	= "\ivory_e36\ivory_e36";  /// simple path to model
		picture = "\ivory_e36\data\portrait_car_CA.paa";
		Icon	= "\ivory_e36\data\map_car_CA.paa";
		editorPreview = "\ivory_e36\data\ivory_e36.jpg";
		...
		displayName = "BMW M3 E36"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_e36_driver";
		driverInAction = "ivory_e36_driver";
		cargoAction[] = {"ivory_e36_cargo","ivory_e36_cargo2","ivory_e36_cargo3"};
		cargoInAction[] = {"ivory_e36_cargo","ivory_e36_cargo2","ivory_e36_cargo3"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_e36\data\bmw_m3_e36_wheel_diffuse_00.paa",
	...
	class ivory_e36: ivory_e36_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_e36_driver = "ivory_e36_driver";
		ivory_e36_cargo = "ivory_e36_cargo";
		ivory_e36_cargo2 = "ivory_e36_cargo2";
		ivory_e36_cargo3 = "ivory_e36_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_e36_driver: Crew
		{
			file = "ivory_e36\anim\driver.rtm";
		};
		class ivory_e36_cargo: Crew
		{
			file = "ivory_e36\anim\cargo.rtm";
		};
		class ivory_e36_cargo2: Crew
		{
			file = "ivory_e36\anim\cargo2.rtm";
		};
		class ivory_e36_cargo3: Crew
		{
			file = "ivory_e36\anim\cargo3.rtm";
		};
	};
};
