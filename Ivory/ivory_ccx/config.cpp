...
class CfgVehicles
{
	...
	class ivory_ccx_base: Car_F
	{
		model 	= "\ivory_ccx\ivory_ccx";  /// simple path to model
		picture = "\ivory_ccx\data\portrait_car_CA.paa";
		Icon	= "\ivory_ccx\data\map_car_CA.paa";
		editorPreview = "\ivory_ccx\data\ivory_ccx.jpg";
		...
		displayName = "Koenigsegg CCX"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_ccx_driver";
		driverInAction = "ivory_ccx_driver";
		cargoAction[] = {"ivory_ccx_cargo"};
		cargoInAction[] = {"ivory_ccx_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_ccx\data\ccx_wheel_diffuse_00.paa",
	...
	class ivory_ccx: ivory_ccx_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_ccx_driver = "ivory_ccx_driver";
		ivory_ccx_cargo = "ivory_ccx_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_ccx_driver: Crew
		{
			file = "ivory_ccx\anim\driver.rtm";
		};
		class ivory_ccx_cargo: Crew
		{
			file = "ivory_ccx\anim\cargo.rtm";
		};
	};
};
