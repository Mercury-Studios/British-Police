...
class CfgVehicles
{
	...
	class ivory_isf_base: Car_F
	{
		model 	= "\ivory_isf\ivory_isf";  /// simple path to model
		picture = "\ivory_isf\data\portrait_car_CA.paa";
		Icon	= "\ivory_isf\data\map_car_CA.paa";
		editorPreview = "\ivory_isf\data\ivory_isf.jpg";
		...
		displayName = "Lexus IS-F"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_isf_driver";
		driverInAction = "ivory_isf_driver";
		cargoAction[] = {"ivory_isf_cargo","ivory_isf_cargo2","ivory_isf_cargo3"};
		cargoInAction[] = {"ivory_isf_cargo","ivory_isf_cargo2","ivory_isf_cargo3"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_isf\data\lexus_is-f_wheel_diffuse_00.paa",
	...
	class ivory_isf: ivory_isf_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_isf_marked: ivory_isf_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_isf\data\ivory_isf_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_marked_norb: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_isf\data\ivory_isf_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_marked_classic: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_isf\data\ivory_isf_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_isf_unmarked: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_isf\data\ivory_isf_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_unmarked_norb: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_isf\data\ivory_isf_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_slicktop: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_isf\data\ivory_isf_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_slicktop_norb: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_isf\data\ivory_isf_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_isf_slicktop_classic: ivory_isf_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lexus IS-F (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_isf\data\ivory_isf_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_isf_driver = "ivory_isf_driver";
		ivory_isf_cargo = "ivory_isf_cargo";
		ivory_isf_cargo2 = "ivory_isf_cargo2";
		ivory_isf_cargo3 = "ivory_isf_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_isf_driver: Crew
		{
			file = "ivory_isf\anim\driver.rtm";
		};
		class ivory_isf_cargo: Crew
		{
			file = "ivory_isf\anim\cargo.rtm";
		};
		class ivory_isf_cargo2: Crew
		{
			file = "ivory_isf\anim\cargo2.rtm";
		};
		class ivory_isf_cargo3: Crew
		{
			file = "ivory_isf\anim\cargo3.rtm";
		};
	};
};
...
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_isf\data\isf_police.paa"; 
	};
