		...
		{
			GearboxRatios[] = {"R1",-2.176,"N",0,"D1",4.60,"D2",2.72,"D3",1.86,"D4",1.46,"D5",1.23,"D6",1.00,"D7",0.82,"D8",0.69}; //
		...
		changeGearMinEffectivity[] = {0.95, 0.15, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88};
		switchTime = 0.31;
		latency = 1.0;
		class Wheels
		{
			class LF
			{
				...
				maxDroop = 0.1;
				sprungMass = 400;
				springStrength = 57000;
				springDamperRate = 4390;
