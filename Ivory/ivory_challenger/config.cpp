...
class CfgVehicles
{
	...
	class ivory_challenger_base: Car_F
	{
		model 	= "\ivory_challenger\ivory_challenger";  /// simple path to model
		picture = "\ivory_challenger\data\portrait_car_CA.paa";
		Icon	= "\ivory_challenger\data\map_car_CA.paa";
		editorPreview = "\ivory_challenger\data\ivory_challenger.jpg";
		...
		displayName = "Dodge Challenger"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_challenger_driver";
		driverInAction = "ivory_challenger_driver";
		cargoAction[] = {"ivory_challenger_cargo","ivory_challenger_cargo2","ivory_challenger_cargo3"};
		cargoInAction[] = {"ivory_challenger_cargo","ivory_challenger_cargo2","ivory_challenger_cargo3"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_challenger\data\dodge_challenger_wheel1_diffuse_00.paa",
	...
	class ivory_challenger: ivory_challenger_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_challenger_marked: ivory_challenger_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_challenger\data\ivory_challenger_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_marked_norb: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_challenger\data\ivory_challenger_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_marked_classic: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_challenger\data\ivory_challenger_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_challenger_unmarked: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_challenger\data\ivory_challenger_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_unmarked_norb: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_challenger\data\ivory_challenger_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_slicktop: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_challenger\data\ivory_challenger_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_slicktop_norb: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_challenger\data\ivory_challenger_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_challenger_slicktop_classic: ivory_challenger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Challenger (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_challenger\data\ivory_challenger_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_challenger_driver = "ivory_challenger_driver";
		ivory_challenger_cargo = "ivory_challenger_cargo";
		ivory_challenger_cargo2 = "ivory_challenger_cargo2";
		ivory_challenger_cargo3 = "ivory_challenger_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_challenger_driver: Crew
		{
			file = "ivory_challenger\anim\driver.rtm";
		};
		class ivory_challenger_cargo: Crew
		{
			file = "ivory_challenger\anim\cargo.rtm";
		};
		class ivory_challenger_cargo2: Crew
		{
			file = "ivory_challenger\anim\cargo2.rtm";
		};
		class ivory_challenger_cargo3: Crew
		{
			file = "ivory_challenger\anim\cargo3.rtm";
		};
	};
};
...
{
	class challenger_police
	{
		displayName = "Police"; 
		texture = "ivory_challenger\data\challenger_police.paa"; 
	};
};