...
class CfgVehicles
{
	...
	class ivory_evox_base: Car_F
	{
		model 	= "\ivory_evox\ivory_evox";  /// simple path to model
		picture = "\ivory_evox\data\portrait_car_CA.paa";
		Icon	= "\ivory_evox\data\map_car_CA.paa";
		editorPreview = "\ivory_evox\data\ivory_evox.jpg";
		...
		displayName = "Mitsubishi Lancer Evolution X"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
castDriverShadow = 0;
weapons[] = {};
		driverAction = "ivory_evox_driver";
		driverInAction = "ivory_evox_driver";
		cargoAction[] = {"ivory_evox_cargo","ivory_evox_cargo2","ivory_evox_cargo3","ivory_evox_cargo4"};
		cargoInAction[] = {"ivory_evox_cargo","ivory_evox_cargo2","ivory_evox_cargo3","ivory_evox_cargo4"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_evox\data\mitsubishi_evox_wheel_diffuse_00.paa",
		...
		class AnimationSources: AnimationSources
		{
			...
			class spoiler: turn_left{initPhase = 1;};
	...
	class ivory_evox: ivory_evox_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_evox_marked: ivory_evox_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Marked)";
		editorPreview = "\ivory_evox\data\ivory_evox_marked.jpg";
...
emergencySiren = 1;
	...
	class ivory_evox_marked_norb: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_evox\data\ivory_evox_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_evox_marked_classic: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_evox\data\ivory_evox_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_evox_unmarked: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_evox\data\ivory_evox_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed = 260+90;
	...
	class ivory_evox_unmarked_norb: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_evox\data\ivory_evox_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed = 260+90;
	...
	class ivory_evox_slicktop: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_evox\data\ivory_evox_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed = 260+90;
	...
	class ivory_evox_slicktop_norb: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_evox\data\ivory_evox_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed = 260+90;
	...
	class ivory_evox_slicktop_classic: ivory_evox_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Mitsubishi Lancer Evolution X (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_evox\data\ivory_evox_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_evox_driver = "ivory_evox_driver";
		ivory_evox_cargo = "ivory_evox_cargo";
		ivory_evox_cargo2 = "ivory_evox_cargo2";
		ivory_evox_cargo3 = "ivory_evox_cargo3";
		ivory_evox_cargo4 = "ivory_evox_cargo4";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_evox_driver: Crew
		{
			file = "ivory_evox\anim\driver.rtm";
		};
		class ivory_evox_cargo: Crew
		{
			file = "ivory_evox\anim\cargo.rtm";
		};
		class ivory_evox_cargo2: Crew
		{
			file = "ivory_evox\anim\cargo2.rtm";
		};
		class ivory_evox_cargo3: Crew
		{
			file = "ivory_evox\anim\cargo3.rtm";
		};
		class ivory_evox_cargo4: Crew
		{
			file = "ivory_evox\anim\cargo4.rtm";
		};
	};
};
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_evox\data\evox_police.paa"; 
	};
};