...
class CfgVehicles
{
	...
	class ivory_lp560_base: Car_F
	{
		model 	= "\ivory_lp560\ivory_lp560";  /// simple path to model
		picture = "\ivory_lp560\data\portrait_car_CA.paa";
		Icon	= "\ivory_lp560\data\map_car_CA.paa";
		editorPreview = "\ivory_lp560\data\ivory_lp560.jpg";
		...
		displayName = "Lamborghini Gallardo"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_lp560_driver";
		driverInAction = "ivory_lp560_driver";
		cargoAction[] = {"ivory_lp560_cargo"};
		cargoInAction[] = {"ivory_lp560_cargo"};

		memoryPointsGetInDriver = "pos driver";
		memoryPointsGetInDriverDir = "pos driver dir";
		memoryPointsGetInCargo[] = {"pos cargo 1"};
		memoryPointsGetInCargoDir[] = {"pos cargo 1 dir"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_lp560\data\lamborghini_gallardo_wheel_diffuse_00.paa",
	...
	class ivory_lp560: ivory_lp560_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_lp560_driver = "ivory_lp560_driver";
		ivory_lp560_cargo = "ivory_lp560_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_lp560_driver: Crew
		{
			file = "ivory_lp560\anim\driver.rtm";
		};
		class ivory_lp560_cargo: Crew
		{
			file = "ivory_lp560\anim\cargo.rtm";
		};
	};
};
