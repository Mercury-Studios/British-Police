...
class CfgVehicles
{
	...
	class ivory_charger_base: Car_F
	{
		model 	= "\ivory_charger\ivory_charger";  /// simple path to model
		picture = "\ivory_charger\data\portrait_car_CA.paa";
		Icon	= "\ivory_charger\data\map_car_CA.paa";
		editorPreview = "\ivory_charger\data\ivory_charger.jpg";
		...
		displayName = "Dodge Charger"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_charger_driver";
		driverInAction = "ivory_charger_driver";
		cargoAction[] = {"ivory_charger_cargo","ivory_charger_cargo2","ivory_charger_cargo3"};
		cargoInAction[] = {"ivory_charger_cargo","ivory_charger_cargo2","ivory_charger_cargo3"};
	...
	class ivory_charger: ivory_charger_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_charger_marked: ivory_charger_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_charger\data\ivory_charger_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_marked_norb: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_charger\data\ivory_charger_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_marked_classic: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_charger\data\ivory_charger_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_charger_unmarked: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_charger\data\ivory_charger_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_unmarked_norb: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_charger\data\ivory_charger_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_slicktop: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_charger\data\ivory_charger_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_slicktop_norb: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_charger\data\ivory_charger_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_charger_slicktop_classic: ivory_charger_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Dodge Charger (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_charger\data\ivory_charger_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_charger_driver = "ivory_charger_driver";
		ivory_charger_cargo = "ivory_charger_cargo";
		ivory_charger_cargo2 = "ivory_charger_cargo2";
		ivory_charger_cargo3 = "ivory_charger_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_charger_driver: Crew
		{
			file = "ivory_charger\anim\driver.rtm";
		};
		class ivory_charger_cargo: Crew
		{
			file = "ivory_charger\anim\cargo.rtm";
		};
		class ivory_charger_cargo2: Crew
		{
			file = "ivory_charger\anim\cargo2.rtm";
		};
		class ivory_charger_cargo3: Crew
		{
			file = "ivory_charger\anim\cargo3.rtm";
		};
	};
};
...
{
	class charger_police
	{
		displayName = "Police"; 
		texture = "ivory_charger\data\charger_police.paa"; 
	};
};