...
class CfgVehicles
{
	...
	class ivory_rev_base: Car_F
	{
		model 	= "\ivory_rev\ivory_rev";  /// simple path to model
		picture = "\ivory_rev\data\portrait_car_CA.paa";
		Icon	= "\ivory_rev\data\map_car_CA.paa";
		editorPreview = "\ivory_rev\data\ivory_rev.jpg";
		...
		displayName = "Lamborghini Reventon"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_rev_driver";
		driverInAction = "ivory_rev_driver";
		cargoAction[] = {"ivory_rev_cargo"};
		cargoInAction[] = {"ivory_rev_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_rev\data\lamborghini_reventon_wheel_diffuse_00.paa",
	...
	class ivory_rev: ivory_rev_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_rev_marked: ivory_rev_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_rev\data\ivory_rev_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_marked_norb: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_rev\data\ivory_rev_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_marked_classic: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_rev\data\ivory_rev_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_rev_unmarked: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_rev\data\ivory_rev_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_unmarked_norb: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_rev\data\ivory_rev_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_slicktop: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_rev\data\ivory_rev_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_slicktop_norb: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_rev\data\ivory_rev_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_rev_slicktop_classic: ivory_rev_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Lamborghini Reventon (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_rev\data\ivory_rev_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_rev_driver = "ivory_rev_driver";
		ivory_rev_cargo = "ivory_rev_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_rev_driver: Crew
		{
			file = "ivory_rev\anim\driver.rtm";
		};
		class ivory_rev_cargo: Crew
		{
			file = "ivory_rev\anim\cargo.rtm";
		};
	};
};
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_rev\data\rev_police.paa"; 
	};
};