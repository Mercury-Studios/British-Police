...
class CfgVehicles
{
	...
	class ivory_911_base: Car_F
	{
		model 	= "\ivory_911\ivory_911";  /// simple path to model
		picture = "\ivory_911\data\portrait_car_CA.paa";
		Icon	= "\ivory_911\data\map_car_CA.paa";
		editorPreview = "\ivory_911\data\ivory_911.jpg";
		...
		displayName = "Porsche 911"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_911_driver";
		driverInAction = "ivory_911_driver";
		cargoAction[] = {"ivory_911_cargo"};
		cargoInAction[] = {"ivory_911_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_911\data\por_rsr74_wheel_diffuse_00.paa",
	...
	class ivory_911: ivory_911_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_911_driver = "ivory_911_driver";
		ivory_911_cargo = "ivory_911_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_911_driver: Crew
		{
			file = "ivory_911\anim\driver.rtm";
		};
		class ivory_911_cargo: Crew
		{
			file = "ivory_911\anim\cargo.rtm";
		};
	};
};
