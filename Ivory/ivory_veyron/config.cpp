...
class CfgVehicles
{
	...
	class ivory_veyron_base: Car_F
	{
		model 	= "\ivory_veyron\ivory_veyron";  /// simple path to model
		picture = "\ivory_veyron\data\portrait_car_CA.paa";
		Icon	= "\ivory_veyron\data\map_car_CA.paa";
		editorPreview = "\ivory_veyron\data\ivory_veyron.jpg";
		...
		displayName = "Bugatti Veyron"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		turboEnabled=1;
		driverAction = "ivory_veyron_driver";
		driverInAction = "ivory_veyron_driver";
		cargoAction[] = {"ivory_veyron_cargo"};
		cargoInAction[] = {"ivory_veyron_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_veyron\data\bugatti_veyron_wheel_diffuse_00.paa",
	...
	class ivory_veyron: ivory_veyron_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_veyron_driver = "ivory_veyron_driver";
		ivory_veyron_cargo = "ivory_veyron_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_veyron_driver: Crew
		{
			file = "ivory_veyron\anim\driver.rtm";
		};
		class ivory_veyron_cargo: Crew
		{
			file = "ivory_veyron\anim\cargo.rtm";
		};
	};
};