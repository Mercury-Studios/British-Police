...
class CfgVehicles
{
	...
	class ivory_wrx_base: Car_F
	{
		model 	= "\ivory_wrx\ivory_wrx";  /// simple path to model
		picture = "\ivory_wrx\data\portrait_car_CA.paa";
		Icon	= "\ivory_wrx\data\map_car_CA.paa";
		editorPreview = "\ivory_wrx\data\ivory_wrx.jpg";
		...
		displayName = "Subaru Impreza WRX STI"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_wrx_driver";
		driverInAction = "ivory_wrx_driver";
		cargoAction[] = {"ivory_wrx_cargo","ivory_wrx_cargo2","ivory_wrx_cargo3","ivory_wrx_cargo4"};
		cargoInAction[] = {"ivory_wrx_cargo","ivory_wrx_cargo2","ivory_wrx_cargo3","ivory_wrx_cargo4"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_wrx\data\subaru_impreza_sti_wheel_diffuse_00.paa",
	...
	class ivory_wrx: ivory_wrx_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_wrx_marked: ivory_wrx_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_wrx\data\ivory_wrx_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_wrx_marked_norb: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_wrx\data\ivory_wrx_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_marked_classic: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_wrx\data\ivory_wrx_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_unmarked: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_wrx\data\ivory_wrx_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_unmarked_norb: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_wrx\data\ivory_wrx_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_slicktop: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_wrx\data\ivory_wrx_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_slicktop_norb: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_wrx\data\ivory_wrx_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
maxSpeed               	= 249+75;
	...
	class ivory_wrx_slicktop_classic: ivory_wrx_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Subaru Impreza WRX STI (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_wrx\data\ivory_wrx_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_wrx_driver = "ivory_wrx_driver";
		ivory_wrx_cargo = "ivory_wrx_cargo";
		ivory_wrx_cargo2 = "ivory_wrx_cargo2";
		ivory_wrx_cargo3 = "ivory_wrx_cargo3";
		ivory_wrx_cargo4 = "ivory_wrx_cargo4";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_wrx_driver: Crew
		{
			file = "ivory_wrx\anim\driver.rtm";
		};
		class ivory_wrx_cargo: Crew
		{
			file = "ivory_wrx\anim\cargo.rtm";
		};
		class ivory_wrx_cargo2: Crew
		{
			file = "ivory_wrx\anim\cargo2.rtm";
		};
		class ivory_wrx_cargo3: Crew
		{
			file = "ivory_wrx\anim\cargo3.rtm";
		};
		class ivory_wrx_cargo4: Crew
		{
			file = "ivory_wrx\anim\cargo4.rtm";
		};
	};
};
...
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_wrx\data\wrx_police.paa"; 
	};
