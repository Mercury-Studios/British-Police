...
soundDammage[]={"", db-5, 1};
soundEngineOnInt[] = {"ivory_c\sound\start", db-8, 1.0};
soundEngineOnExt[] = {"ivory_c\sound\start", db-7, 1.0, 200};
...
class Sounds
{
	...
	#define HZ_IDLE FACTOR_RPM(100,1150)
	#define HZ_RPM1 FACTOR_RPM(800,2100)
	#define HZ_RPM2	FACTOR_RPM(1800,3100)
	#define HZ_RPM3 FACTOR_RPM(3100,4500)
	#define HZ_RPM4 FACTOR_RPM(4300,4900)
	#define HZ_RPM5 FACTOR_RPM(4700,5200)
	#define HZ_RPM6 FACTOR_RPM(5400,6800)

	#define VOLUME_IDLE FACTOR2_RPM(400,700,1000,1100)
	#define VOLUME_RPM1 FACTOR2_RPM(970,1100,1300,2100)
	#define VOLUME_RPM2 FACTOR2_RPM(1250,2050,2800,3100)
	#define VOLUME_RPM3 FACTOR2_RPM(2850,3050,4000,4300)
	#define VOLUME_RPM4 FACTOR2_RPM(3900,4200,5100,5300)
	#define VOLUME_RPM5 FACTOR2_RPM(4900,5250,6000,6200)
	#define VOLUME_RPM6 FACTOR_RPM(5900,6500)


	class Idle_ext
	{
		sound[]	=	{"ivory_c\sound\idle", db-18,1, 50};
	...
	{
		//sound[] = 	{""};
		sound[]	=	{"ivory_c\sound\low",	db-18,1, 100};
	...
	{
		//sound[] = 	{""};
		sound[]	=	{"ivory_c\sound\mid",	db-18,1, 110};
	...
	{
		//sound[] = 	{""};
		sound[]	=	{"ivory_c\sound\mid",	db-18,1, 120};
	...
	{
		//sound[] = 	{""};
		sound[]	=	{"ivory_c\sound\high",	db-18,1, 130};
	...
	{
		//sound[] = 	{""};
		sound[]	=	{"ivory_c\sound\high",	db-18,1, 140};
		frequency	=	0.95	+	HZ_RPM6*0.35;
	...
	{
		//sound[]={};
		sound[]	=	{"ivory_c\sound\idle", db-22,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
	...
	{
		//sound[]={};
		sound[]	=	{"ivory_c\sound\low",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
		//sound[]={};
		sound[]	=	{"ivory_c\sound\mid",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	{
		//sound[]={};
		sound[]	=	{"ivory_c\sound\high",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
	...
	class TiresRockOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext_tires_dirt_soft_1", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*rock*(speed factor[2, 20])";
	};
	class TiresSandOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext-tires-sand1", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*sand*(speed factor[2, 20])";
	};
	class TiresGrassOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext_tires_dirt_soft_2", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*grass*(speed factor[2, 20])";
	};
	class TiresMudOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext-tires-mud2", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*mud*(speed factor[2, 20])";
	};
	class TiresGravelOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext_tires_gravel_1", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*gravel*(speed factor[2, 20])";
	};
	class TiresAsphaltOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\ext_tires_asfalt_2", db-14, 1.0, 60};
		frequency = "1";
		volume = "camPos*asphalt*(speed factor[2, 20])";
	};
	class NoiseOut
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\noises\noise_ext_car_3", db-17, 1.0, 90};
		frequency = "1";
	...
	class TiresRockIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_dirt_soft_1", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*rock*(speed factor[2, 20])";
	};
	class TiresSandIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int-tires-sand2", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*sand*(speed factor[2, 20])";
	};
	class TiresGrassIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_dirt_soft_2", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*grass*(speed factor[2, 20])";
	};
	class TiresMudIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int-tires-mud2", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*mud*(speed factor[2, 20])";
	};
	class TiresGravelIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_gravel_1", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*gravel*(speed factor[2, 20])";
	};
	class TiresAsphaltIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_asfalt_2", db-30, 1.0};
		frequency = "1";
		volume = "(1-camPos)*asphalt*(speed factor[2, 20])";
	};
	class NoiseIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\noises\noise_int_car_3", db-30, 1.0};
		frequency = "1";
