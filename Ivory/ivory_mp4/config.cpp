...
class CfgVehicles
{
	...
	class ivory_mp4_base: Car_F
	{
		model 	= "\ivory_mp4\ivory_mp4";  /// simple path to model
		picture = "\ivory_mp4\data\portrait_car_CA.paa";
		Icon	= "\ivory_mp4\data\map_car_CA.paa";
		editorPreview = "\ivory_mp4\data\ivory_mp4.jpg";
		...
		displayName = "McLaren MP4-12C"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_mp4_driver";
		driverInAction = "ivory_mp4_driver";
		cargoAction[] = {"ivory_mp4_cargo"};
		cargoInAction[] = {"ivory_mp4_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_mp4\data\mclaren_mp4-12c_wheel_diffuse_00.paa",
		...
		class AnimationSources: AnimationSources
		{
			...
			class spoiler_brake: spoiler {animPeriod = 0.1;};
		};
		class UserActions
		{
			class Manual
	...
	class ivory_mp4: ivory_mp4_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_mp4_driver = "ivory_mp4_driver";
		ivory_mp4_cargo = "ivory_mp4_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_mp4_driver: Crew
		{
			file = "ivory_mp4\anim\driver.rtm";
		};
		class ivory_mp4_cargo: Crew
		{
			file = "ivory_mp4\anim\cargo.rtm";
		};
	};
};