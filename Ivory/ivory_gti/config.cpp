...
class CfgVehicles
{
	...
	class ivory_gti_base: Car_F
	{
		model 	= "\ivory_gti\ivory_gti";  /// simple path to model
		picture = "\ivory_gti\data\portrait_car_CA.paa";
		Icon	= "\ivory_gti\data\map_car_CA.paa";
		editorPreview = "\ivory_gti\data\ivory_gti.jpg";
		...
		displayName = "Volkswagen Golf GTI"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_gti_driver";
		driverInAction = "ivory_gti_driver";
		cargoAction[] = {"ivory_gti_cargo","ivory_gti_cargo2","ivory_gti_cargo3"};
		cargoInAction[] = {"ivory_gti_cargo","ivory_gti_cargo2","ivory_gti_cargo3"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_gti\data\vw_golf_gti_wheel_diffuse_00.paa",
	...
	class ivory_gti: ivory_gti_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_gti_driver = "ivory_gti_driver";
		ivory_gti_cargo = "ivory_gti_cargo";
		ivory_gti_cargo2 = "ivory_gti_cargo2";
		ivory_gti_cargo3 = "ivory_gti_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_gti_driver: Crew
		{
			file = "ivory_gti\anim\driver.rtm";
		};
		class ivory_gti_cargo: Crew
		{
			file = "ivory_gti\anim\cargo.rtm";
		};
		class ivory_gti_cargo2: Crew
		{
			file = "ivory_gti\anim\cargo2.rtm";
		};
		class ivory_gti_cargo3: Crew
		{
			file = "ivory_gti\anim\cargo3.rtm";
		};
	};
};
