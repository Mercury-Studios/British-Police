...
soundDammage[]={"", db-5, 1};
soundEngineOnInt[] = {"ivory_suburban\sound\lexus_startup.wss", db-8, 1.0};
soundEngineOnExt[] = {"ivory_suburban\sound\lexus_startup.wss", db-7, 1.0, 200};
...
class Sounds
{
	...
	#define HZ_RPM6 FACTOR_RPM(5100,6800)
	...
	class Idle_ext
	{
		sound[]	=	{"ivory_suburban\sound\lexus_idle", db-15,	1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*VOLUME_IDLE;
	};
	class Engine
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offverylow",	db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*camPos*VOLUME_RPM1;
	};
	class Engine1_ext
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offlow",	db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*camPos*VOLUME_RPM2;
	};
	class Engine2_ext
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offmid",	db-15,1, 100};
	...
	class Engine4_ext
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offhigh",	db-15,1, 100};
	...
	class IdleThrust
	{
	sound[] = {"ivory_suburban\sound\lexus_onidle", db-15,1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust
	{
	sound[] = {"ivory_suburban\sound\lexus_onlow", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_suburban\sound\lexus_onmidhigh", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM3;
	};
	class Engine3_Thrust_ext
	{
	sound[] = {"ivory_suburban\sound\lexus_onmid", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM4;
	};
	class Engine4_Thrust_ext
	{
	sound[] = {"ivory_suburban\sound\lexus_onhigh", db-15,1, 100};
	...
	class Idle_int
	{
		sound[]	=	{"ivory_suburban\sound\lexus_idle", db-30,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*VOLUME_IDLE;
	};
	class Engine_int
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offverylow",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM1;
	};
	class Engine1_int
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offlow",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM2;
	};
	class Engine2_int
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offmid",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	class Engine4_int
	{
		sound[]	=	{"ivory_suburban\sound\lexus_offhigh",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
	...
	{
	sound[] = {"ivory_suburban\sound\lexus_onidle", db-30,1 };
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust_int
	{
	sound[] = {"ivory_suburban\sound\lexus_onlow", db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_suburban\sound\lexus_onmidhigh", db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM3;
	};
	class Engine3_Thrust_int
	{
	sound[] = {"ivory_suburban\sound\lexus_onmid", db-30,1 };
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM4;
	};
	class Engine4_Thrust_int
	{
	sound[] = {"ivory_suburban\sound\lexus_onhigh", db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.3;
	...
	class TiresSandIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int-tires-sand2", db-12, 1.0};
		frequency = "1";
		volume = "(1-camPos)*sand*(speed factor[2, 20])";
	};
	class TiresGrassIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_dirt_soft_2", db-12, 1.0};
		frequency = "1";
		volume = "(1-camPos)*grass*(speed factor[2, 20])";
	};
	class TiresMudIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int-tires-mud2", db-12, 1.0};
		frequency = "1";
		volume = "(1-camPos)*mud*(speed factor[2, 20])";
	};
	class TiresGravelIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_gravel_1", db-12, 1.0};
		frequency = "1";
		volume = "(1-camPos)*gravel*(speed factor[2, 20])";
	};
	class TiresAsphaltIn
	{
		sound[] = {"A3\Sounds_F\vehicles\soft\tires\int_tires_asfalt_2", db-12, 1.0};
		frequency = "1";
