...
class CfgVehicles
{
	...
	class ivory_suburban_base: Car_F
	{
		model 	= "\ivory_suburban\ivory_suburban";  /// simple path to model
		picture = "\ivory_suburban\data\portrait_car_CA.paa";
		Icon	= "\ivory_suburban\data\map_car_CA.paa";
		editorPreview = "\ivory_suburban\data\ivory_suburban.jpg";
		...
		displayName = "Chevrolet Suburban"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_suburban_driver";
		driverInAction = "ivory_suburban_driver";
		cargoAction[] = {"ivory_suburban_cargo","ivory_suburban_cargo01","ivory_suburban_cargo01","ivory_suburban_cargo02","ivory_suburban_cargo02"};
		cargoInAction[] = {"ivory_suburban_cargo","ivory_suburban_cargo01","ivory_suburban_cargo01","ivory_suburban_cargo02","ivory_suburban_cargo02"};

		memoryPointsGetInDriver = "pos driver";
		memoryPointsGetInDriverDir = "pos driver dir";
		memoryPointsGetInCargo[] = {"pos cargo 1","pos cargo 2","pos cargo 3","pos cargo 2","pos cargo 3"};
		memoryPointsGetInCargoDir[] = {"pos cargo 1 dir","pos cargo 2 dir","pos cargo 3 dir","pos cargo 2 dir","pos cargo 3 dir"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_suburban\data\suv_body_co.paa",
	...
	class ivory_suburban: ivory_suburban_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_suburban_marked: ivory_suburban_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_marked_norb: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_marked_classic: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_suburban_unmarked: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_unmarked_norb: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_slicktop: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_suburban\data\ivory_suburban_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_slicktop_norb: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_suburban\data\ivory_suburban_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_suburban_slicktop_classic: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_suburban\data\ivory_suburban_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_suburban_ems: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (EMS/Marked)";
		editorSubcategory="IvoryEMSMarked";
		editorPreview = "\ivory_suburban\data\ivory_suburban_ems.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		...
		emergencyTinted = 0;
		emergencySpotlight = 0;
		texture="suburban_ems";

		maxSpeed = 193+75;
		enginePower = 510;
		peakTorque = 790;
	};
	class ivory_suburban_ems_slicktop: ivory_suburban_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Chevrolet Suburban (EMS/Slicktop)";
		editorSubcategory="IvoryEMSSlicktop";
		editorPreview = "\ivory_suburban\data\ivory_suburban_ems_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_suburban_driver = "ivory_suburban_driver";
		ivory_suburban_cargo = "ivory_suburban_cargo";
		ivory_suburban_cargo01 = "ivory_suburban_cargo01";
		ivory_suburban_cargo02 = "ivory_suburban_cargo02";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_suburban_driver: Crew
		{
			file = "ivory_suburban\anim\SUV_Driver.rtm";
		};
		class ivory_suburban_cargo: Crew
		{
			file = "ivory_suburban\anim\SUV_Cargo.rtm";
		};
		class ivory_suburban_cargo01: Crew
		{
			file = "ivory_suburban\anim\SUV_Cargo01.rtm";
		};
		class ivory_suburban_cargo02: Crew
		{
			file = "ivory_suburban\anim\SUV_Cargo02.rtm";
		};
	};
};
...
{
	class suburban_police
	{
		displayName = "Police"; 
		texture = "ivory_suburban\data\suburban_police.paa"; 
	};
	
	class suburban_ems
	{
		displayName = "EMS"; 
		texture = "ivory_suburban\data\ems.paa"; 
	};
};