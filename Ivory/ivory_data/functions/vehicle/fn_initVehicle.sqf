...
if (_tintWindows < 0) then { _tintWindows = 0 };
if (_tintWindows > 1) then { _tintWindows = 1 };
if (_tintLights < 0) then { _tintLights = 0 };
if (_tintLights > 1) then { _tintLights = 1 };

_car setVariable ["ivory_windowtint",str _tintWindows,true];
_car setVariable ["ivory_lighttint",str _tintLights,true];

_tintWindows = 0.5+_tintWindows*0.5;
_tintLights = 0.5+_tintLights*0.5;
