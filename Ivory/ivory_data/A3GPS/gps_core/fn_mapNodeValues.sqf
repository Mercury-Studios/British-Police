...
private _crossRoad_isHighWay = [_crossRoad] call ivory_gps_misc_fnc_isHighWay;

{
  ...
  for "_i" from 0 to 1 step 0 do {
    ...
    if(_countConnected > 2 || _currRoad in _exceptions || _countConnected isEqualTo 1) exitWith {  
      _currRoad_isHighWay = [_currRoad] call ivory_gps_misc_fnc_isHighWay;
...
[gps_allCrossRoadsWithWeight,str _crossRoad,_linkedCrossRoads] call ivory_gps_misc_fnc_hashTable_set;
