...
if(!canSuspend) exitWith {["can't suspend here"] call ivory_gps_fnclog};
...
(_display displayCtrl 1601) ctrlSetText (["STR_CANCEL"] call ivory_gps_fnclocalize);
(_display displayCtrl 1600) ctrlSetText (["STR_OK"] call ivory_gps_fnclocalize);
