...
(_display displayCtrl 1600) ctrlSetText (["STR_CANCEL"] call ivory_gps_fnclocalize);
(_display displayCtrl 1601) ctrlSetText (["STR_OK"] call ivory_gps_fnclocalize);
(_display displayCtrl 1000) ctrlSetText (["STR_MENU_KEY_CHOICE"] call ivory_gps_fnclocalize);
