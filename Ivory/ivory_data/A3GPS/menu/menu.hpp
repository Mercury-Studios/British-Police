...
class GPS_menu {
	...
	class controls {
		...
		class header: A3GPS_RscText
		{
			...
			text = "IVORY NAVIGATION MENU"; //--- ToDo: Localize;
...
class gps_menu_map {
	...
	class controls {
		...
		class exec_saved: A3GPS_RscButton
		{
			...
			x = 0.731103 * safezoneW + safezoneX;
			y = 0.5 * safezoneH + safezoneY;
			w = 0.103581 * safezoneW;
			h = 0.035 * safezoneH;
		};
		class save_saved: A3GPS_RscButton
		{
			idc = 1601;
		...
		class stop_saved: A3GPS_RscButton
		{
			idc = 1603;
		...
		class destination_saved: A3GPS_RscButton
		{
			idc = 1604;
