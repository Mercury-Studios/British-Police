...
class CfgVehicles
{
	...
	class ivory_prius_base: Car_F
	{
		model 	= "\ivory_prius\ivory_prius";  /// simple path to model
		picture = "\ivory_prius\data\portrait_car_CA.paa";
		Icon	= "\ivory_prius\data\map_car_CA.paa";
		editorPreview = "\ivory_prius\data\ivory_prius.jpg";
		...
		displayName = "Toyota Prius"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_prius_driver";
		driverInAction = "ivory_prius_driver";
		cargoAction[] = {"ivory_prius_cargo","ivory_prius_cargo2","ivory_prius_cargo3"};
		cargoInAction[] = {"ivory_prius_cargo","ivory_prius_cargo2","ivory_prius_cargo3"};
		...
		hiddenSelectionsTextures[] = {
			...
			"#(argb,8,8,3)color(0.768627,0.768627,0.768627,1.0,co)",
		...
		class AnimationSources: AnimationSources
		{
			...
			class spoiler: turn_left{initPhase = 0;};
	...
	class ivory_prius: ivory_prius_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_prius_marked: ivory_prius_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Marked)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_prius\data\ivory_prius_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_marked_norb: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_prius\data\ivory_prius_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_marked_classic: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_prius\data\ivory_prius_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_prius_unmarked: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_prius\data\ivory_prius_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_unmarked_norb: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_prius\data\ivory_prius_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_slicktop: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_prius\data\ivory_prius_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_slicktop_norb: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_prius\data\ivory_prius_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_prius_slicktop_classic: ivory_prius_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_prius\data\ivory_prius_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_prius_taxi: ivory_prius_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="Toyota Prius (Taxi)";
		editorSubcategory="IvoryTaxi";
		editorPreview = "\ivory_cv\data\ivory_cv_taxi.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_prius_driver = "ivory_prius_driver";
		ivory_prius_cargo = "ivory_prius_cargo";
		ivory_prius_cargo2 = "ivory_prius_cargo2";
		ivory_prius_cargo3 = "ivory_prius_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_prius_driver: Crew
		{
			file = "ivory_prius\anim\driver.rtm";
		};
		class ivory_prius_cargo: Crew
		{
			file = "ivory_prius\anim\cargo.rtm";
		};
		class ivory_prius_cargo2: Crew
		{
			file = "ivory_prius\anim\cargo2.rtm";
		};
		class ivory_prius_cargo3: Crew
		{
			file = "ivory_prius\anim\cargo3.rtm";
		};
		class ivory_prius_cargo4: Crew
		{
			file = "ivory_prius\anim\cargo4.rtm";
		};
	};
};
...
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_prius\data\prius_police.paa"; 
	};
	class prius_taxi
	{
		displayName = "Taxi"; 
		texture = "ivory_prius\data\prius_taxi.paa"; 
	};
};