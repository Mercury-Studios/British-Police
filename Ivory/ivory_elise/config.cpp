...
class CfgVehicles
{
	...
	class ivory_elise_base: Car_F
	{
		model 	= "\ivory_elise\ivory_elise";  /// simple path to model
		picture = "\ivory_elise\data\portrait_car_CA.paa";
		Icon	= "\ivory_elise\data\map_car_CA.paa";
		editorPreview = "\ivory_elise\data\ivory_elise.jpg";
		...
		displayName = "Lotus Elise 11R"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_elise_driver";
		driverInAction = "ivory_elise_driver";
		cargoAction[] = {"ivory_elise_cargo","ivory_elise_cargo2","ivory_elise_cargo3"};
		cargoInAction[] = {"ivory_elise_cargo","ivory_elise_cargo2","ivory_elise_cargo3"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_elise\data\lotus_elise_wheel_diffuse_00.paa",
	...
	class ivory_elise: ivory_elise_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_elise_driver = "ivory_elise_driver";
		ivory_elise_cargo = "ivory_elise_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_elise_driver: Crew
		{
			file = "ivory_elise\anim\driver.rtm";
		};
		class ivory_elise_cargo: Crew
		{
			file = "ivory_elise\anim\cargo.rtm";
		};
	};
};
