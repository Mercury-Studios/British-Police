...
soundDammage[]={"", db-5, 1};
soundEngineOnInt[] = {"ivory_f1\sound\mclaren_startup.wss", db-8, 1.0};
soundEngineOnExt[] = {"ivory_f1\sound\mclaren_startup.wss", db-7, 1.0, 200};
...
class Sounds
{
	...
	class Idle_ext
	{
		sound[]	=	{"ivory_f1\sound\mclaren_idle", db-15,	1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*VOLUME_IDLE;
	};
	class Engine
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offverylow",	db-15,1, 100};
	...
	class Engine2_ext
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offlow",	db-15,1, 100};
	...
	class Engine4_ext
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offmid",	db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*camPos*VOLUME_RPM5;
	};
	class Engine5_ext
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offhigh",	db-15,1, 100};
	...
	class IdleThrust
	{
	sound[] = {"ivory_f1\sound\mclaren_onidle", db-15,1, 100};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust
	{
	sound[] = {"ivory_f1\sound\mclaren_onverylow", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_f1\sound\mclaren_onlow", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	{
	sound[] = {"ivory_f1\sound\mclaren_onmid", db-15,1, 100};
		frequency	=	0.8	+	HZ_RPM5*0.3;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM5;
	};
	class Engine5_Thrust_ext
	{
	sound[] = {"ivory_f1\sound\mclaren_onhigh", db-15,1, 100};
	...
	class Idle_int
	{
		sound[]	=	{"ivory_f1\sound\mclaren_idle", db-30,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*VOLUME_IDLE;
	};
	class Engine_int
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offverylow",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	class Engine2_int
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offlow",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	class Engine4_int
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offmid",	db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM5;
	};
	class Engine5_int
	{
		sound[]	=	{"ivory_f1\sound\mclaren_offhigh",	db-30,1 };
		frequency	=	0.95	+	HZ_RPM6*0.15;
	...
	{
	sound[] = {"ivory_f1\sound\mclaren_onidle", db-30,1 };
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
	};
	class EngineThrust_int
	{
	sound[] = {"ivory_f1\sound\mclaren_onverylow", db-30,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
	...
	{
	sound[] = {"ivory_f1\sound\mclaren_onlow", db-30,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
	...
	{
	sound[] = {"ivory_f1\sound\mclaren_onmid", db-30,1 };
		frequency	=	0.8	+	HZ_RPM5*0.3;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM5;
	};
	class Engine5_Thrust_int
	{
	sound[] = {"ivory_f1\sound\mclaren_onhigh", db-30,1 };
		frequency	=	0.9	+	HZ_RPM6*0.2;
