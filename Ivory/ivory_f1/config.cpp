...
class CfgVehicles
{
	...
	class ivory_f1_base: Car_F
	{
		model 	= "\ivory_f1\ivory_f1";  /// simple path to model
		picture = "\ivory_f1\data\portrait_car_CA.paa";
		Icon	= "\ivory_f1\data\map_car_CA.paa";
		editorPreview = "\ivory_f1\data\ivory_f1.jpg";
		...
		displayName = "McLaren F1"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_f1_driver";
		driverInAction = "ivory_f1_driver";
		cargoAction[] = {"ivory_f1_cargo","ivory_f1_cargo2"};
		cargoInAction[] = {"ivory_f1_cargo","ivory_f1_cargo2"};

		memoryPointsGetInDriver = "pos driver";
		memoryPointsGetInDriverDir = "pos driver dir";
		memoryPointsGetInCargo[] = {"pos driver","pos cargo"};
		memoryPointsGetInCargoDir[] = {"pos driver dir","pos cargo dir"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_f1\data\mclaren_f1_wheel_diffuse_00.paa",
	...
	class ivory_f1: ivory_f1_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_f1_driver = "ivory_f1_driver";
		ivory_f1_cargo = "ivory_f1_cargo";
		ivory_f1_cargo2 = "ivory_f1_cargo2";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_f1_driver: Crew
		{
			file = "ivory_f1\anim\driver.rtm";
		};
		class ivory_f1_cargo: Crew
		{
			file = "ivory_f1\anim\cargo.rtm";
		};
		class ivory_f1_cargo2: Crew
		{
			file = "ivory_f1\anim\cargo2.rtm";
		};
	};
};
