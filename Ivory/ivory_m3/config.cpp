...
class CfgVehicles
{
	...
	{
		model 	= "\ivory_m3\ivory_m3";  /// simple path to model
		picture = "\ivory_m3\data\portrait_car_CA.paa";
		Icon	= "\ivory_m3\data\map_car_CA.paa";
		editorPreview = "\ivory_m3\data\ivory_m3.jpg";
		...
		displayName = "BMW M3 E92"; /// displayed in Editor
...
weapons[] = {};
		...
		driverAction = "ivory_m3_driver";
		driverInAction = "ivory_m3_driver";
		cargoAction[] = {"ivory_m3_cargo","ivory_m3_cargo2","ivory_m3_cargo3"};
		cargoInAction[] = {"ivory_m3_cargo","ivory_m3_cargo2","ivory_m3_cargo3"};
		...
		hiddenSelectionsTextures[] = {
			...
			"ivory_m3\data\bmw_m3_e92_wheel_diffuse_00.paa",
	...
	class ivory_m3: ivory_m3_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_m3_marked: ivory_m3_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Marked)";
		editorSubcategory="pr_police_traffic";
		editorPreview = "\ivory_m3\data\ivory_m3_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
	...
	class ivory_m3_markedARV: ivory_m3_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (ARV/Marked)";
		editorSubcategory="pr_police_traffic";
		editorPreview = "\ivory_m3\data\ivory_m3_marked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
	...
	class ivory_m3_marked_norb: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Marked/No Pushbar)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_m3\data\ivory_m3_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_m3_marked_classic: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Marked/Classic)";
		editorSubcategory="IvoryPoliceMarked";
		editorPreview = "\ivory_m3\data\ivory_m3_marked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
emergencySiren = 1;
	...
	class ivory_m3_unmarked: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Unmarked)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_m3\data\ivory_m3_unmarked.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_m3_unmarked_norb: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Unmarked/No Pushbar)";
		editorSubcategory="IvoryPoliceUnmarked";
		editorPreview = "\ivory_m3\data\ivory_m3_unmarked_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_m3_slicktop: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Slicktop)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_m3\data\ivory_m3_slicktop.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_m3_slicktop_norb: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Slicktop/No Pushbar)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_m3\data\ivory_m3_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
...
emergencySiren = 1;
	...
	class ivory_m3_slicktop_classic: ivory_m3_marked /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		displayName="BMW M3 E92 (Police/Slicktop/Classic)";
		editorSubcategory="IvoryPoliceSlicktop";
		editorPreview = "\ivory_m3\data\ivory_m3_slicktop_norb.jpg";
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_m3_driver = "ivory_m3_driver";
		ivory_m3_cargo = "ivory_m3_cargo";
		ivory_m3_cargo2 = "ivory_m3_cargo2";
		ivory_m3_cargo3 = "ivory_m3_cargo3";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_m3_driver: Crew
		{
			file = "ivory_m3\anim\driver.rtm";
		};
		class ivory_m3_cargo: Crew
		{
			file = "ivory_m3\anim\cargo.rtm";
		};
		class ivory_m3_cargo2: Crew
		{
			file = "ivory_m3\anim\cargo2.rtm";
		};
		class ivory_m3_cargo3: Crew
		{
			file = "ivory_m3\anim\cargo3.rtm";
		};
	};
};
...
class CfgIvoryTextures
{
	...
	{
		displayName = "Police"; 
		texture = "ivory_m3\data\m3_police.paa"; 
	};
	class m3_police_armed
	{
		displayName = "Armed Police"; 
		texture = "ivory_m3\data\m3_police_armed.paa"; 
	};
};