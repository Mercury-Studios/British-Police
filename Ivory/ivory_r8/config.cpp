...
class CfgVehicles
{
	...
	class ivory_r8_base: Car_F
	{
		model 	= "\ivory_r8\ivory_r8";  /// simple path to model
		picture = "\ivory_r8\data\portrait_car_CA.paa";
		Icon	= "\ivory_r8\data\map_car_CA.paa";
		editorPreview = "\ivory_r8\data\ivory_r8.jpg";
		...
		displayName = "Audi R8"; /// displayed in Editor
		supplyRadius = 2;
viewCargoShadow = 0;
viewDriverShadow = 0;
castCargoShadow = 0;
...
weapons[] = {};
		...
		driverAction = "ivory_r8_driver";
		driverInAction = "ivory_r8_driver";
		cargoAction[] = {"ivory_r8_cargo"};
		cargoInAction[] = {"ivory_r8_cargo"};
		...
		hiddenSelectionsTextures[]={
			...
			"ivory_r8\data\audi_r8s_wheel_diffuse_00.paa",
	...
	class ivory_r8: ivory_r8_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
	...
	class ivory_r8_spyder: ivory_r8_base /// some class that is going to be visible in editor
	{
		author	= "Ivory";
		editorSubcategory="Ivory";
		scope	= 2; 			/// makes the car visible in editor
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		editorPreview = "\ivory_r8\data\ivory_r8_spyder.jpg";

		model 	= "\ivory_r8\ivory_r8_spyder";  /// simple path to model
		displayName = "Audi R8 Spyder"; /// displayed in Editor
...
class CfgMovesBasic
{
	...
	class ManActions
	{
		ivory_r8_driver = "ivory_r8_driver";
		ivory_r8_cargo = "ivory_r8_cargo";
	};
};
class CfgMovesMaleSdr: CfgMovesBasic
{
	...
	{
		class Crew;
		class ivory_r8_driver: Crew
		{
			file = "ivory_r8\anim\driver.rtm";
		};
		class ivory_r8_cargo: Crew
		{
			file = "ivory_r8\anim\cargo.rtm";
		};
	};
};
